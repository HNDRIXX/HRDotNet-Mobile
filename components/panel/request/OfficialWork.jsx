...
export default function OfficialWorkPanel ( onAnimate ) {
    ...
    const filteredData = data.filter((newItem) => {
            const formattedDate = formattedDateString(newItem.officialWorkDate)
    ...
    useEffect(() => {
        ...
        filteredData.forEach((item) => {
          const formattedDate = formattedDateString(item.officialWorkDate)
          const itemAppliedDate = moment(formattedDate, 'MMMM DD YYYY')
                    ...
                    { filteredData.length > 0 ? (
                        <ScrollView>
                            ...
                            { filteredData.map((item, index) => {
                                const itemAppliedDate = moment(formattedDateString(item.officialWorkDate), 'MMMM DD YYYY')
