...
export default function RequestSummary({ navigation }) {
    ...
    return (
        <>
            ...
            <SuccessPromptPage
                title={"Success"}
                subTitle = {`Your COS request for ${moment(route.params?.startDate, "YYYYMMDD").format("MMM DD")} - ${moment(route.params?.endDate, "YYYYMMDD").format("DD, YYYY")} was successfully submitted. We will get back to you soon.`}
                buttonText={"OKAY"}
